...
export const Standing = ({ data }: { data: MeetApiResponse }) => {
  ...
  return (
    <div className="standing">
      ...
      <div className="standing-config-bar">
        <div>
          <div>Division</div>
          <select
            onChange={(e) => {
      ...
      {/* <div className="standing-category-name">
        {forecasted ? "Forecasted" : ""} {selectedDivision?.name} -{" "}
        {selectedWeightClass?.name}
      </div> */}

      <div className="standing-header">
        <img src={logo} className="standing-logo" alt="logo" />
      ...
      <div>
        ...
        {topLifters.map((l) => {
          ...
          return (
            <div key={l.id} className="standing-row">
              <div className="standing-item">{place || "-"}</div>
