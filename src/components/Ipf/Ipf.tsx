...
export const Ipf = ({ data }: { data: MeetApiResponse }) => {
  ...
  return (
    <div className="ipf">
      ...
      {/* <div className="ipf-category-name">
        {forecasted ? "Forecasted" : ""} {selectedDivision?.name} -{" "}
        {selectedWeightClass?.name}
      </div> */}

      <div className="ipf-header">
        <img src={logo} className="ipf-logo" alt="logo" />
        <div className="ipf-column">
          <div className="ipf-division">{selectedDivision?.name}</div>
          <div className="ipf-status">
            {forecasted ? "Forecasted" : "Current ipf"}
          </div>
        </div>
        <div className="ipf-weight">
      ...
      <div>
        <div className="ipfsub-row">
          <div className="ipf-item">Place</div>
          <div className="ipf-item">Name</div>
          {/* <div className="ipf-item">Squat</div>
          <div className="ipf-item">Bench</div>
          <div className="ipf-item">Dead</div> */}
          <div className="ipf-item">{scoreBy}</div>
        </div>
        {topLifters.map((l) => {
          ...
          return (
            <div key={l.id} className="ipf-row">
              ...
              {/* <div className="ipf-item">{l.bestSquat}</div>
              <div className="ipf-item">{l.bestBench}</div>
              <div className="ipf-item">{l.bestDead}</div> */}
              <div className="ipf-item">
